...
${defs}
  ...
  <div class="canvas-board">
    <div class="canvas-bar">
      ...
      <button class="btn" type="button" id="canvas-download">Download it</button>
    ...
    <p class="canvas-keys"><strong>Drag a shape out of the tray</strong> and drop it where you want it, or click it to put it on the middle of the board. Then drag a piece, or tab to it and use the <strong>arrow keys</strong> to move it, <strong>+</strong> and <strong>&#8722;</strong> to resize, <strong>[</strong> and <strong>]</strong> to turn it a little, <strong>f</strong> to flip it. <strong>Delete</strong> takes it off, and <strong>Ctrl</strong> or <strong>\u2318</strong> with <strong>Z</strong> undoes it. On a <strong>?</strong> of your own, <strong>Enter</strong> opens it for writing. Rivers, paths and bridges are in the tray running four ways already; <strong>Turn</strong> moves a piece an eighth of a circle at a time, and <strong>Flip</strong> mirrors it, so anything can end up pointing anywhere.</p>
  </div>
